        ...
        <>
            ...
            <div className={styles.cateContain}>
                ...
                <div className={styles.buttonContain}>
                    <button className={styles.category}>Top Selling</button>
                    {   
                        category.map((a,b) => <button key={b} className={styles.category} onClick={() => topImagePrev.current.innerHTML = GroceriesSvg({a})
